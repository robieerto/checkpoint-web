<template>
  <div
    class="self-stretch flex flex-col items-start justify-start max-w-full text-justify text-29xl text-material-theme-extended-deep-blue-signature-seed font-roboto"
  >
    <div
    ...
    >
      ...
      >
        <div
          class="flex-1 flex flex-col items-start justify-end pt-0 px-0 pb-[7px] box-border max-w-full"
        >
          <div
            class="self-stretch flex flex-col items-start justify-start gap-[47px] max-w-full mq900:gap-[23px]"
          >
            <div
            ...
            <div
              class="self-stretch shadow-[6px_12px_15px_rgba(0,_0,_0,_0.25)] rounded-11xl bg-material-theme-extended-deep-blue-signature-seed flex flex-col items-start justify-start pt-12 px-[119px] pb-[7px] box-border gap-[53px] max-w-full z-[1] text-left text-45xl text-schemes-on-primary mq900:gap-[26px] mq900:pt-[31px] mq900:px-[29px] mq900:pb-5 mq900:box-border mq1350:pl-[59px] mq1350:pr-[59px] mq1350:box-border"
            >
              <div
                class="w-[1128px] h-[531px] relative shadow-[6px_12px_15px_rgba(0,_0,_0,_0.25)] rounded-11xl bg-material-theme-extended-deep-blue-signature-seed hidden max-w-full"
              />
              <div
                class="w-[792px] flex flex-row items-start justify-start py-0 px-px box-border max-w-full"
              >
                <h1
                  class="m-0 flex-1 relative text-inherit leading-[53px] font-bold font-inherit inline-block max-w-full z-[2]"
                >
                  Zefektivněte řízení svého hotelu pomocí Checkpointu
                </h1>
              </div>
              <div
                class="w-[860px] flex flex-row items-start justify-start pt-0 px-px pb-10 box-border max-w-full text-5xl"
              >
                <h3
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="flex-1 shadow-[7px_9px_4px_rgba(0,_0,_0,_0.25)] bg-material-theme-extended-deep-blue-signature-light-color-container flex flex-row items-start justify-start pt-[18px] px-[26px] pb-[17px] z-[1] text-center text-schemes-on-primary-container"
              >
                <div
                  class="h-[70px] w-[146px] relative bg-material-theme-extended-deep-blue-signature-light-color-container hidden"
                />
                <a
                  class="[text-decoration:none] flex-1 relative tracking-[-0.25px] leading-[17px] text-[inherit] z-[1]"
                  >Rezervovat ukázku</a
                >
              </div>
              <button
          ...
          <img
            class="w-[295px] flex-1 relative max-h-full object-contain z-[1]"
            loading="lazy"
            alt=""
      ...
      <div
        class="w-[1737px] flex flex-row items-start justify-start py-0 px-px box-border max-w-full"
      >
        <div
          class="flex-1 shadow-[6px_12px_15px_rgba(0,_0,_0,_0.25)] rounded-11xl bg-schemes-inverse-on-surface flex flex-col items-start justify-start pt-[15px] pb-[52px] pr-[303px] pl-[374px] box-border gap-[45px] max-w-full z-[1] mq900:gap-[22px] mq900:pl-[93px] mq900:pr-[75px] mq900:box-border mq1350:pl-[187px] mq1350:pr-[151px] mq1350:box-border mq450:pl-5 mq450:pr-5 mq450:box-border"
        >
          <div
          ...
          >
            ...
            >
              Důvěřují nám hotely různých velikostí
            </h1>
          </div>
          <div
    ...
    >
      ...
      <div class="absolute top-[255px] left-[286.5px] w-[1110px] h-[397.5px]">
        <div
          class="absolute top-[197px] left-[0px] w-[422.5px] h-[24.5px] z-[2] flex items-center justify-center"
        >
          <img
            class="w-full h-full z-[2] object-contain absolute left-[7px] top-[6px] [transform:scale(1.661)]"
            alt=""
            src="/background.svg"
          />
        </div>
        <img
          class="absolute top-[338px] left-[701.5px] w-[408.5px] h-[59.5px] object-contain z-[2]"
          loading="lazy"
          alt=""
          src="/vector-5.svg"
        />
        <img
          class="absolute top-[0px] left-[689.5px] w-[408.5px] h-[59.5px] object-contain z-[2]"
          loading="lazy"
          alt=""
          src="/vector-4.svg"
        />
        <img
          class="absolute top-[49px] left-[418.5px] w-[348.6px] h-[334.2px] object-contain z-[4]"
          alt=""
          src="/group-4663@2x.png"
        />
      </div>
      <div
        class="absolute top-[50px] left-[62px] w-[1656px] flex flex-col items-start justify-start gap-[43px] max-w-full text-left text-45xl text-material-theme-extended-deep-blue-signature-seed"
      >
        <div
        ...
        <div
          class="self-stretch flex flex-row items-start justify-between max-w-full gap-[20px] text-right text-29xl mq1350:flex-wrap mq1350:justify-center"
        >
          <div
            class="w-[627px] flex flex-col items-start justify-start pt-[73px] px-0 pb-0 box-border min-w-[627px] max-w-full mq900:min-w-full mq1350:flex-1"
          >
            <h1
              class="m-0 self-stretch relative text-inherit leading-[44px] font-semibold font-inherit z-[2] mq900:text-19xl mq900:leading-[35px] mq450:text-10xl mq450:leading-[26px]"
            >
              <p class="m-0">Nedostatečný přehled</p>
              <p class="m-0">o probíhajících činnostech</p>
            </h1>
          </div>
          <h3
